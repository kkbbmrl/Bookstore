...
<head>
    ...
    <title>My Liked Books - Fassila Bookstore</title>
    ...
    <style>
        ...
        .liked-book-card .img img:hover {
            transform: scale(1.05);
        }
        
        .liked-book-card .content {
            padding: 15px;
        }
        
        .liked-book-card .title {
            font-weight: 600;
            margin-bottom: 5px;
            font-size: 16px;
        }
        
        .liked-book-card .author {
            color: #666;
            font-size: 14px;
            margin-bottom: 10px;
        }
        
        .liked-book-card .action-buttons {
            display: flex;
            justify-content: space-between;
            margin-top: 15px;
        }
        
        .liked-book-card .view-button {
            background: #6c5dd4;
            color: white;
            border: none;
            padding: 8px 15px;
        ...
        .liked-book-card .view-button:hover {
            background: #5a4cbe;
        }
        
        .liked-book-card .remove-button {
            background: #f44336;
            color: white;
            border: none;
            padding: 8px 15px;
        ...
        .liked-book-card .remove-button:hover {
            background: #d32f2f;
        }
        ...
        .empty-liked .browse-button:hover {
            background: #5a4cbe;
        }
...
<body>
    ...
    <div class="breadcrumb-container">
        <ul class="breadcrumb">
            ...
            <li><a href="#">Liked Books</a></li>
        </ul>
    </div>
    
    <div class="liked-header">
        <div class="liked-container">
            <h1>My Liked Books <span class="liked-count">(<?php echo $total_liked; ?>)</span></h1>
        </div>
    </div>
    ...
    <div class="liked-container">
        <?php if (empty($liked_books)): ?>
            <div class="empty-liked">
                ...
                <h2>Your liked books list is empty</h2>
                <p>Browse our catalog and add books you like to your collection.</p>
                <a href="Pages/book-filter.php" class="browse-button">Browse Books</a>
            </div>
        <?php else: ?>
            <div class="liked-books">
                <?php foreach ($liked_books as $book): ?>
                    <div class="liked-book-card" data-wishlist-id="<?php echo $book['wishlist_id']; ?>">
                        <div class="img">
                            <?php if ($book['is_api_book']): ?>
                                <a href="Pages/book-detail.php?id=<?php echo $book['api_id']; ?>&api=1">
                        ...
                        <div class="content">
                            ...
                            <div class="action-buttons">
                                <?php if ($book['is_api_book']): ?>
                                    <a href="Pages/book-detail.php?id=<?php echo $book['api_id']; ?>&api=1" class="view-button">View Details</a>
                                <?php else: ?>
                                    <a href="Pages/book-detail.php?id=<?php echo $book['id']; ?>" class="view-button">View Details</a>
                                <?php endif; ?>
                            ...
                            <?php if (!$book['is_api_book']): ?>
                            <div class="cart-button-container" style="margin-top: 10px;">
                                <button class="add-to-cart-button" data-book-id="<?php echo $book['id']; ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // Handle removing items from liked books
            const removeButtons = document.querySelectorAll('.remove-button');
            
            removeButtons.forEach(button => {
                button.addEventListener('click', function() {
                    const wishlistId = this.getAttribute('data-id');
                    const bookCard = this.closest('.liked-book-card');
                    ...
                    fetch('Pages/remove_favorite.php', {
                        method: 'POST',
                        body: formData
                    })
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                ...
                                // Update count
                                const countElem = document.querySelector('.liked-count');
                                ...
                                // Show empty message if no more liked books
                                if (currentCount === 0) {
                                ...
                                showToast('Book removed from liked books');
                            }, 300);
                        } else {
                ...
                button.addEventListener('click', function() {
                    ...
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            // If item already in cart, show different message
